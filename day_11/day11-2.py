    ...
    def runTurn(self):
        ...
        for _m in updated_items:
            if _m % self.mod_test_value == 0:
                thrown_items.append((self.true_monkey, _m % 9699690))
            else:
                thrown_items.append((self.false_monkey, _m % 9699690))
...
print(f"Test divisor: {divisor}")

# too high - 13544898692, didn't use commond multiplier for actual input
# too low - 12489889815, using the 

# 19909890 for actual input 
